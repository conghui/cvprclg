...
NUMPY_FILE  = '/home/rice/cvprclg/data/working/models/%s/AOI_3_Paris_pred.npy' % (MODEL)
PNG_DIR     = '/home/rice/cvprclg/data/working/models/%s/AOI_3_Paris_test_png_%s' % (MODEL, MODEL)
...
for idx in range(len(image_list)):
  ...
  imsave(png_fn, image_array[idx][0])
